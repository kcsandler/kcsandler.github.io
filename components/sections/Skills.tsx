      ...
      <div className="grid border-y border-line md:grid-cols-2">
        {skillGroups.map((group, index) => (
          <div
            key={group.category}
            className={cn(
              "skill-cell border-b border-line px-5 py-8 last:border-b-0 sm:px-8 sm:py-10",
              "md:border-b-0",
          ...
          >
            <h3 className="skill-kicker font-mono text-[11px] uppercase tracking-[0.16em] text-accent">
